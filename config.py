...
# WORKLOAD VPC
WORKLOAD_VPC_NAME = "WorkloadVPC"
WORKLOAD_VPC_ID_NAME = "WorkloadVpcID"
WORKLOAD_VPC_CIDR_BLOCK = '10.6.0.0/16'
WORKLOAD_SUBNETS_CONFIG = [
    {
        "name": "WorkloadsTGW-A",
    ...
    {
        "name": "WorkloadsApp-A",
        "cidr_block": "10.6.64.0/18",
        "az": 0,
        "public?": False,
    },
    {
        "name": "WorkloadsApp-B",
        "cidr_block": "10.6.128.0/18",
        "az": 1,
        "public?": False,
    },
    {
        "name": "WorkloadsApp-C",
        "cidr_block": "10.6.192.0/18",
        "az": 2,
        "public?": False,
    }
]
...
GATEWAY_VPC_ATTACHMENT_NAMESET = ["IncomingAttachmentsTGW", "InspectionAttachmentsTGW",
                                  "OutcomingAttachmentsTGW", "WorkloadAttachmentsTGW", "EndpointAttachmentsTGW"]
